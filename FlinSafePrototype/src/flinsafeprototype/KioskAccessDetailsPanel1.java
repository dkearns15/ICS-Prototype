...
public class KioskAccessDetailsPanel1 extends javax.swing.JPanel {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       try {
        ...
        try {
            System.out.println(n + "," + new Date() + "," + "Access Request" + "," + (String) Location.getSelectedItem() + ",Needs Access To: " + RoomText.getText() + "; Type: " + TypeText.getText() + "; Comments: " + CommentsText.getText());
            writer.append(n + "," + new Date() + "," + "Access Request" + "," + (String) Location.getSelectedItem() + ",Needs Access To: " + RoomText.getText() + "; Type: " + TypeText.getText() + "; Comments: " + CommentsText.getText());
            writer.newLine();
