 ...
 * @author Bryn
 */
public class PhonePanelSnakeSummary extends javax.swing.JPanel {

    JFrame parent;
    /**
     * Creates new form PhonePanelSnakeSummary
     */
    public PhonePanelSnakeSummary() {
        initComponents();
    }
    
    public PhonePanelSnakeSummary(JFrame parent, String area, String room, String type, String size, String comment) {
        initComponents();
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Snake Sighting Summary");
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                    ...
                                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                                        ...
                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            ...
                                                            .addComponent(TypeText, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                            .addComponent(SizeText, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        ...
                        .addComponent(jLabel10, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 367, Short.MAX_VALUE))
                    .addContainerGap()))
        );
    ...
    private void Back1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Back1ActionPerformed
        ...
        parent.setContentPane(new PhonePanelSnake(parent, area, room, type, size, comment));
        parent.revalidate();
    ...
    private void ConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmActionPerformed
        ...
        try {
            System.out.println(n + "," + currentDate + "," + "Snake Sighting" + "," + AreaText.getText() + "," + RoomText.getText() + "," + "," + "," + "," +  TypeText.getText() + ","  + SizeText.getText() + "," + CommentText.getText()+ "," + "Matthew Flinders");
            writer.append(n + "," + currentDate + "," + "Snake Sighting" + "," + AreaText.getText() + "," + RoomText.getText() + "," + "," + "," + "," +  TypeText.getText() + ","  + SizeText.getText() + "," + CommentText.getText()+ "," + "Matthew Flinders");
            writer.newLine();
